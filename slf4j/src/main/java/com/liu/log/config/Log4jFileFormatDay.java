...
/**
 * @Description: 如果使用log4j要生成日志目录格式为每天产生一个按日期的文件夹(yyyy-MM-dd),需要使用该配置，重写RollingFileAppender的方法
 * @Author:W_LIURUNKAI
 * @Date:2019/9/26 17:23
 */
//public class Log4jFileFormatDay extends RollingFileAppender {
//    private Logger LogLog = LoggerFactory.getLogger(this.getClass());
